      ...
      const server = app.listen(PORT, () => {
        ...
        setTimeout(() => {
          void import('./services/audio.service').then(({ generateSpeech }) => {
            const julesFR = "Salut ! Trop cool de te voir ici. Pour préparer tes missions de la semaine, tu peux me dire en quelle classe tu vas à la rentrée ?";
            const julesEN = "Hey! So great to have you here. To set up your missions, can you tell me what grade you'll be going into in September?";
            void generateSpeech(julesFR, 'jules', 'fr').catch(() => {});
            void generateSpeech(julesEN, 'jules', 'en').catch(() => {});
